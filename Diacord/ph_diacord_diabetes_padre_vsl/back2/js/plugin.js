    ...
    return n = {}, i.m = s = [function(t, e, i) {
        ...
        (function(t) {
            ...
            function o(s, i, t) {
                function n(t) {
                    var e = h,
                        i = l;
                    return h = l = void 0, g = t, u = s.apply(i, e)
                }

                function o(t) {
                    var e = t - p;
                    return void 0 === p || i <= e || e < 0 || f && c <= t - g
                }

                function r() {
                    var t = C();
                    return o(t) ? e(t) : void(d = setTimeout(r, function(t) {
                        var e = i - (t - p);
                        return f ? x(e, c - (t - g)) : e
                    }(t)))
                }

                function e(t) {
                    return d = void 0, v && h ? n(t) : (h = l = void 0, u)
                }

                function a() {
                    var t = C(),
                        e = o(t);
                    if (h = arguments, l = this, p = t, e) {
                        if (void 0 === d) return function(t) {
                            return g = t, d = setTimeout(r, i), m ? n(t) : u
                        }(p);
                        if (f) return d = setTimeout(r, i), n(p)
                    }
                    return void 0 === d && (d = setTimeout(r, i)), u
                }
                var h, l, c, u, d, p, g = 0,
                    m = !1,
                    f = !1,
                ...
                return i = _(i) || 0, y(t) && (m = !!t.leading, c = (f = "maxWait" in t) ? b(_(t.maxWait) || 0, i) : c, v = "trailing" in t ? !!t.trailing : v), a.cancel = function() {
                    void 0 !== d && clearTimeout(d), h = p = l = d = void(g = 0)
                }, a.flush = function() {
                    return void 0 === d ? u : e(C())
                }, a
            }
        ...
        (function(t) {
            ...
            function _(t) {
                ...
                t = t.replace(o, "");
                var i = a.test(t);
                return i || h.test(t) ? l(t.slice(2), i ? 2 : 8) : r.test(t) ? n : +t
            }
        ...
        e.default = function(t, e) {
            var i = new o(s);
            r = e, i.observe(n.documentElement, {
                childList: !0,
                subtree: !0,
                removedNodes: !0
            })
...
function(n, t, e, o) {
    ...
    function u(t) {
        ...
        return !!c("transition")
    }() || (n.support.transition = new String(u("transition")), n.support.transition.end = i.transition.end[n.support.transition]), l() && (n.support.animation = new String(u("animation")), n.support.animation.end = i.animation.end[n.support.animation]), s() && (n.support.transform = new String(u("transform")), n.support.transform3d = h())
}(window.Zepto || window.jQuery, window, document);